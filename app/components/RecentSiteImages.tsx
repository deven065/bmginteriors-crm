      ...
      <div className="flex-1 flex gap-3">
        {images.map((img) => (
          <div key={img.id} className="flex-1 rounded-xl overflow-hidden relative group cursor-pointer">
            <Image src={img.src} alt="Site" fill sizes="(max-width: 768px) 33vw, 12vw" className="object-cover transition-transform duration-300 group-hover:scale-110" priority={img.id <= 2} />
